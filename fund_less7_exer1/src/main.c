...
#define THREAD0_PROIORITY 7
#define THREAD1_PRIORIRTY 7

void thread0(void)
{
	while (1) {
		  /* STEP 3 - Call printk() to display a simple string "Hello, I am thread0" */
		printk("Hello, I am thread0!!! Nothing man being nowhere nothread... \n\r");
...
void thread1(void)
{
	while (1) {
		...
		printk("Hello, I am thread1! I am the Rubber Souls of Beatles\n\r");
...
K_THREAD_DEFINE(thread0_id, STACKSIZE, thread0, NULL, NULL, NULL, THREAD0_PROIORITY, 0, 0);
K_THREAD_DEFINE(thread1_id, STACKSIZE, thread1, NULL, NULL, NULL, THREAD0_PROIORITY, 0, 0);